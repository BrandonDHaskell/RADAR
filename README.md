...
| 6 | Lever, Ashby, Workable adapters (later extended with Dayforce) | Done |
...
internal/
  ...
  ingest/        Fetcher interface + one adapter per ATS (Greenhouse, Lever, Ashby, Workable, Dayforce)
